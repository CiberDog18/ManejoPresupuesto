...
namespace ManejoPresupuesto.Validaciones
{
    public class MensajesDeErrorIdentity : IdentityErrorDescriber
    {
        ...
        public override IdentityError PasswordMismatch() { return new IdentityError { Code = nameof(PasswordMismatch), Description = "Contraseña Incorrecto." }; }
        ...
        public override IdentityError PasswordRequiresUniqueChars(int uniqueChars) { return new IdentityError { Code = nameof(PasswordRequiresUniqueChars), Description = $"La Contraseña requiere {uniqueChars} caracteres únicos" }; }
